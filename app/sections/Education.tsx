...
export default function Education() {
  return (
    <section
      id="education"
      className="relative py-28 px-8 md:px-20 border-t border-gray-300 overflow-hidden"
    >
      <div className="wave-bg" />

      <div className="relative z-10 max-w-5xl mx-auto">

        <h2 className="text-3xl md:text-4xl font-semibold mb-16 text-slate-900">
          Education
        </h2>
        ...
        <div className="space-y-12">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:justify-between">
              ...
              <div className="text-slate-500 text-sm mt-3 md:mt-0">
