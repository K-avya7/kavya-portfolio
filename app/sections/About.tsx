...
export default function About() {
  return (
    <section
      id="about"
      className="relative py-24 px-8 md:px-20 border-t border-gray-300 overflow-hidden"
    >
        ...
        <div className="grid md:grid-cols-[1.05fr_1fr] gap-16 items-center">
          ...
          >
            <div className="relative w-[380px] h-[480px]">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-gray-300">
                <Image
                  src="/profile.png"
                  alt="Kavya Agrawal"
                  width={380}
          ...
          >
            ...
            <div
              className="text-slate-700 leading-relaxed space-y-4 text-sm md:text-base"
